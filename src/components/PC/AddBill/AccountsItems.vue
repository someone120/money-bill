<template>
  <div class="p-2">
    ...
    <div v-else class="flex flex-col items-center justify-center py-12 text-gray-500">
      ...
      <p class="text-sm font-medium text-gray-600 mb-1">{{ $t("addBillAccount.noAccounts") }}</p>
      <p class="text-xs text-gray-400 text-center">{{ $t("addBillAccount.addAccountPrompt") }}</p>
    </div>
